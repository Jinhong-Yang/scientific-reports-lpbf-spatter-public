...
The source image pixels originate from the AI-Hub Metal 3D-Printing Spark Image Data resource (dataset 71476) and are not redistributed. Users must obtain the source under the provider's current terms. The public release at https://github.com/Jinhong-Yang/scientific-reports-lpbf-spatter-public, version `v1.0.1`, contains shareable split metadata, aggregate numerical results, bootstrap outputs, figure source data, artifact hashes, and aggregate reconstruction instructions.
